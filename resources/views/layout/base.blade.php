...
<head>
    ...
    <title>Athaya Rohadatul Yaqutah 5025221235</title>
          ...
          <li class="nav-item menu-open"
           class = "nav-item has-treeview {{ request()->is('pertemuan1/*') ? 'menu-open' : '' }} ">
            ...
            <ul class="nav nav-treeview">
                   ...
                   <li class="nav-item">
                       <a href="{{ route('basic') }}"
                           class="nav-link {{ request()->routeIs('basic') ? 'active' : '' }}">
                           <i class="far fa-circle nav-icon"></i>
                           <p>Basic Paremeter</p>
                       </a>
                   </li>
                   ...
                   <li class="nav-item">
                       <a href="{{ route('named') }}"
                           class="nav-link {{ request()->Is('named') ? 'active' : '' }}">
                           <i class="far fa-circle nav-icon"></i>
                           <p>Named Paremeter</p>
                       </a>
                   </li>
                   <li class="nav-item">
                       <a href="{{ route('group') }}"
                           ...
                           <i class="far fa-circle nav-icon"></i>
                           <p>Route Groups Paremeter</p>
                       </a>
                   </li>
                   <li class="nav-item">
                       <a href="/nonexistent-route"
                           class="nav-link {{ request()->is('fallback') ? 'active' : '' }}">
                           <i class="far fa-circle nav-icon"></i>
                           <p>Fallback Paremeter</p>
                       </a>
                   </li>
               </ul>
          </li>
